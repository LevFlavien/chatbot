...
public class AdaptateurUser {
	...
	public Response generateDB() {
		gestionUser.add(new User("1234", "Alex", "Medina"));
		gestionUser.add(new User(null, "Amandine", "Medina"));
		gestionUser.add(new User(null, "Adrien", "Medina"));
		gestionUser.add(new User(null, "Romain", "Medina"));
		gestionUser.add(new User(null, "Flavien", "Medina"));
